...
class Factory
{
    ...
    /**
     * @var \Cloudteam\ModelGenerator\Model\Config
     */
    protected $config;

    /**
     * @var \Cloudteam\ModelGenerator\Model\ModelManager
     */
    protected $models;

    /**
     * @var \Cloudteam\ModelGenerator\Model\Mutator[]
     */
    protected $mutators = [];
    ...
    /**
     * @return \Cloudteam\ModelGenerator\Model\Mutator
     */
    ...
    /**
     * @return \Cloudteam\ModelGenerator\Model\ModelManager
     */
    ...
    /**
     * @param \Cloudteam\ModelGenerator\Model\Model $model
     ...
     * @param mixed $default
     *
     * @return mixed|\Cloudteam\ModelGenerator\Model\Config
     */
